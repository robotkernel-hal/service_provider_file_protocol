...
class MainProject(ConanFile):
    ...
    description = "robotkernel-5 service provider for file protocol devices."
    settings = "os", "compiler", "build_type", "arch"
    exports_sources = "src/*", "README.wiki", "project.properties", "service_provider_file_protocol.pc.in", "Makefile.am", "m4/*", "configure.ac", "LICENSE"
