...
class MainProject(ConanFile):
    name = "service_provider_file_protocol_ln_msgdef"
    url = "https://rmc-github.robotic.dlr.de/robotkernel/service_provider_file_protocol"
    author = "Robert Burger robert.burger@dlr.de"
    license = "GPLv3"
    description = "service_provider_file_protocol ln message definitions"
    settings = None
    exports_sources = [
        "*",
    ]
    ...
    def package(self):
        ...
        with chdir(self, self.build_folder):
            for dirpath, dirnames, filenames in os.walk("service_provider_file_protocol"):
